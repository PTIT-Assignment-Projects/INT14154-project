...
Toàn bộ quá trình huấn luyện được thực hiện trên GPU NVIDIA H100 với sự hỗ trợ của PyTorch~\cite{paszke2019pytorch}. Việc sử dụng GPU cho phép huấn luyện nhanh hơn đáng kể so với CPU, đặc biệt quan trọng khi huấn luyện với toàn bộ tập dữ liệu gồm 159,571 mẫu và 10 epoch. Thời gian huấn luyện cho mỗi epoch dao động từ khoảng 2 phút (Transformer, do xử lý song song) đến khoảng 9-10 phút (BiLSTM, Attention BiLSTM, RCNN, do xử lý tuần tự hai hướng).
