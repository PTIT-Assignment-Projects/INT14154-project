...
\renewcommand{\lstlistingname}{Đoạn mã} % Thay đổi tên hiển thị từ "Listing" thành "Đoạn mã"

% Định nghĩa danh mục đoạn mã
% \newlistof{listings}{lol}{DANH MỤC ĐOẠN MÃ}
% \newcommand{\listoflistings}{%
%     \section*{DANH MỤC ĐOẠN MÃ}
%     \addcontentsline{toc}{section}{DANH MỤC ĐOẠN MÃ}
%     \begingroup
%     \let\oldnumberline\numberline
%     \renewcommand{\numberline}{Đoạn mã~\oldnumberline}
%     \listof{listings}
%     \endgroup
% }
